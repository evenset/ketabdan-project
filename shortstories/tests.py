...
class ShortStoryFormTests(TestCase):
    ...
    def test_ShortStory_valid(self):
        user_id = User.objects.create(id=1)
        form = ShortStoryForm(data={'author':user_id.id, 'status':'p', 'title':"Villette", 'body':"a"*3501, 'publication_date':'2000-08-30'})
